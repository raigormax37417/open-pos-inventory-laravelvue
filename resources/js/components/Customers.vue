                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" v-show="!editmode">Añadir nuevo cliente</h5>
                            <h5 class="modal-title" v-show="editmode">Editar detalles del cliente</h5>
                        ...
                        <form @submit.prevent="editmode ? updateCustomer() : createCustomer()">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input v-model="form.contactNo" type="number" name="contactNo" class="form-control"
