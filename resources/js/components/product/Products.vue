                      ...
                      >
                        <b-form-input id="sku" v-model="form.sku" type="text" name="sku"
                            ...
                            <b-form-group label="Name" label-for="name" label-cols-sm="3" label-align-sm="right">
                                <b-form-input id="name" v-model="form.name" type="text" name="name" class="form-control"
                                    :class="{ 'is-invalid': form.errors.has('name') }"></b-form-input>
                                <has-error :form="form" field="name"></has-error>
                            </b-form-group>

                            <b-form-group label="Description" label-for="description" label-cols-sm="3"
                                label-align-sm="right">
                            ...
                            <b-form-group label="Unit Price" label-for="price" label-cols-sm="3" label-align-sm="right">
                                <b-form-input id="price" v-model="form.price" type="text" name="price"
                                    class="form-control"
                                    :class="{ 'is-invalid': form.errors.has('price') }"></b-form-input>
                                <has-error :form="form" field="price"></has-error>
                            </b-form-group>

                            <b-form-group label="Stock" label-for="stocks" label-cols-sm="3" label-align-sm="right">
                                <b-form-input id="stocks" v-model="form.stocks" type="text" name="stocks"
                                    class="form-control"
                                    :class="{ 'is-invalid': form.errors.has('stocks') }"></b-form-input>
                                <has-error :form="form" field="stocks"></has-error>
                            </b-form-group>

                            <b-form-group label="Crit. Level" label-for="criticalLevel" label-cols-sm="3"
                                label-align-sm="right">
                                <b-form-input id="criticalLevel" v-model="form.criticalLevel" type="text"
                                    name="criticalLevel" class="form-control"
                                    :class="{ 'is-invalid': form.errors.has('criticalLevel') }"></b-form-input>
                                <has-error :form="form" field="criticalLevel"></has-error>
                            </b-form-group>

                            <b-form-group label="Category" label-for="category_id" label-cols-sm="3"
                                label-align-sm="right">
                            ...
                            <b-form-group v-show="editmode" label="Update Reason" label-for="updateReason"
                                label-cols-sm="3" label-align-sm="right">
                                <b-form-input id="updateReason" v-model="form.update_reason" type="text"
                                    name="updateReason" class="form-control"
                                    :class="{ 'is-invalid': form.errors.has('updateReason') }"></b-form-input>
                ...
                <b-row>
                    ...
                    <b-col cols="2">
                        <b-btn id="addbutton" variant="outline-secondary" @click="newModal">
                            <b-icon icon="plus"></b-icon>Añadir nuevo</b-btn>
                    </b-col>
                </b-row>
                <b-row>
                    <b-col></b-col>
                    <b-col cols="2" style="display:flex">
                        ...
                        <download-excel :data="filteredRows2" type="csv" name="filename.xlsx" class="exports">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr v-for="sam in filteredRows2" :key="sam.id">
                        ...
                        <td v-html="highlightMatches(sam.stocks)" v-if="sam.stocks <= sam.criticalLevel"
                            style="color:red;" class="toCenter"></td>
