<template>
    <section class="content">
        <div class="container-fluid">
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Editar numero de serie</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
                        </div>

                        <div class="modal-body">
                            {{ form.id }}
                            <b-form-group label="SKU" label-for="sku" label-cols-sm="3" label-align-sm="right">
                                <b-form-select v-model="form.sku" :options="pro" value-field="sku" text-field="sku"
                                    required></b-form-select>
                            </b-form-group>

                            <b-form-group label="Serial No." label-for="name" label-cols-sm="3" label-align-sm="right">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-success" @click="submitUpdate()">
                                Actualizar
                            </button>
                        </div>
                    </div>
            ...
            <div class="container">
                <h1 class="display-4">Lista de numero de serie</h1>
                <b-row>
                    <b-col>
                    ...
                    <b-col cols="2">
                        <b-btn variant="outline-secondary" v-b-modal.filts @click="test()"><b-icon icon="plus"></b-icon>
                            Añadir nuevo</b-btn>
                    </b-col>
                </b-row>
            </div>
            ...
            <b-modal id="filts" title="Add New Serial No." header-bg-variant="secondary" size="lg" hide-footer>
                <b-container>
                    <b-row>
                        <b-col cols="5">
                            <label class="text-muted">Unidades de mantenimiento en exitencia (SKU)</label>
                            <b-form-select v-model="selected" :options="pro" value-field="data" text-field="sku"
                                required></b-form-select>
                        </b-col>
                        <b-col>
                            <label class="text-muted">Numero de serie</label>
                        ...
                        <b-col cols="8">
                            <b-row>
                                <b-col style="text-align: center">
                                    ...
                                    <small>Total de articulos</small>
                                </b-col>
                                ...
                                <b-col style="text-align: center">
                                    <br />
                                    <h3 v-if="selected.stock == null" style="letter-spacing: 2px; color: red">
                                        0
                                    </h3>
                                    <h3 v-else style="letter-spacing: 2px; color: red">
                                        {{ selected.stock - z }}
                                    </h3>
                                    <small>Articulos sin numero de serie</small>
                                </b-col>
                                <b-col cols="1" style="text-align: center">
                                    <br />
                                    <h3>+</h3>
                                ...
                                <b-col style="text-align: center">
                                    ...
                                    <small>Articulos con numero de serie</small>
                                </b-col>
                            </b-row>
                        </b-col>
                        <b-col>
                            <br />
                            <br />
                            <b-btn @click="createSerialnum()" style="width: 100%; height: 50%">Guardar</b-btn>
            ...
            <b-alert v-model="showyellow" class="m-0 rounded-0" style="z-index: 2000" variant="danger"
                v-if="x - filteredRows.length > 0">
                <h5>{{ x - filteredRows.length }}</h5>
                Articulos sin numero de serie
            </b-alert>
            <br />
            <br />

            <h4 class="text-muted">{{ filteredRows.length }} Articulos</h4>
            ...
            <table class="table">
                ...
                <tbody>
                    <tr v-for="(i, index) in filteredRows.slice().reverse()" :key="index">
                        ...
                        <td>{{ i.orderno }}</td>
                        <td>
                            <p v-if="new Date('July 14, 1995 12:00:00') < new Date(i.orderdate)">{{
                                new
                                                            Date(i.orderdate).toLocaleDateString()
                            }}</p>
                        </td>
                        <td>{{ i.returnno }}</td>
