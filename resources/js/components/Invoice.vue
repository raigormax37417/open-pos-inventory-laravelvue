        ...
        <div class="container noPrint">
            <b-row>
                <b-col style="display: flex">
                    <b style="margin: auto; padding-right: 10px">Cliente:</b>
                    <b-input-group>
                        <b-form-select v-model="selected" :options="customerx" value-field="data"
                        ...
                        <b-modal id="cusModal" title="Enter Customer Information" hide-footer no-close-on-backdrop>
                            <form @submit.prevent="createCustomer()">
                                <div>
                                    ...
                                    <b-form-group>
                                        <label>Contacto No.</label>
                                        <b-form-input v-model="form.contactNo" type="number"
                                            name="contactNo"></b-form-input>
                                    </b-form-group>
                                    <b-form-group>
                                ...
                                <div style="text-align: right">
                                    <b-btn type="button" variant="outline-secondary" @click="clearAddCus()">Limpiar
                                        todo</b-btn>
                                    <b-btn type="submit" variant="outline-success"
                                        @click="$bvModal.hide('cusModal')">Crear cliente</b-btn>
                                </div>
                            </form>
                        </b-modal>
                    </div>
            ...
            <b-row>
                <b-col cols="3">
                    <div class="mt-3" style="display: flex">
                        <b style="padding-right: 10px">Contacto No: </b>{{ selected.contactNo }}
                    </div>
                </b-col>
                <b-col>
                    <div class="mt-3" style="display: flex">
                        <b style="padding-right: 10px">Direccion: </b>{{ selected.address }}
                    </div>
                </b-col>
                <b-col cols="2">
                    <div class="mt-3 text-right pull-right">
                        <b-btn variant="outline-danger" @click="clearSelectCus()">Clear</b-btn>
                    </div>
                </b-col>
            </b-row>
       ...
       {{optVal}}
        <datalist id="my-list-id">
            ...
            <div>
                <br />
                <br />
                <b-input placeholder="enter serial number" v-model="serial" @keyup.enter="onEnter"></b-input>
                <b-alert v-model="showyellow" class="m-0 rounded-0" style="z-index: 2000"
                ...
                <div class="text-right pull-right">
                    <b-btn @click="outx()" variant="outline-success">verificar</b-btn>
                </div>
            </div>
        </div>
