                        ...
                        <form @submit.prevent="submitUpdate()">
                            <div class="modal-body">
                                <div class="form-group">
                                    <label>Editar</label>
                                    <b-form-select v-model="form.returnStatus" :options="options" size="lg"
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="(j, index) in cartx2" :key="index">
                                    ...
                                    <td>{{ j.ssku }}</td>
                                    <td>
                                        <b-btn variant="danger" @click="removeToList(index)">X</b-btn>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <tbody>
                    <template v-for="(i, index) in ProductsWithSerialNos">
                        <tr :key="index" v-if="i.returnno != null">
                            ...
                            <td>{{ i.remarks }}</td>
                            <td>
                                <b-icon icon="pencil-square" v-b-modal="modalId(i.serialnumber)" class="aycons"
                                    @click="xyz(i.remarks)"></b-icon>
                                <b-modal :id="'modal' + i.serialnumber"
                                    :title="'Return Remarks for Serial No. ' + i.serialnumber" size="lg" centered
                                    hide-footer>
                                    <b-form-textarea id="textarea" v-model="remarkText" placeholder="Enter something..."
                            ...
                            <td>
                                <b-badge variant="primary"
                                    v-if="i.returnStatus === 'Pending'">{{ i.returnStatus }}</b-badge>
                                <b-badge variant="warning"
                                    v-if="i.returnStatus === 'Repair'">{{ i.returnStatus }}</b-badge>
                                <b-badge variant="info" v-if="i.returnStatus === 'Fixed'">{{ i.returnStatus }}</b-badge>
                                <b-badge variant="success"
                                    v-if="i.returnStatus === 'Release'">{{ i.returnStatus }}</b-badge>
                            </td>
                            <td>
