    ...
    <section class="content">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="info-box mb-3" v-b-toggle.daily>
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text"><b class="space">ventas diarias</b></span>
                    ...
                    <b-collapse id="daily" :title="'Daily Sales : ' + dateToday" header-bg-variant="light">
                        <b-card>
                            <table class="table">
                                <thead>
                                    <th>
                                        <small><b>Id de compra</b></small>
                                    </th>
                                    <th>
                                        <small><b>ID de compra</b></small>
                                    </th>
                                    <th>
                                        <small><b>Importe debido</b></small>
                                    </th>
                                </thead>
                                <tbody>
        ...
        totalSalesToday.toLocaleString()
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="info-box mb-3" v-b-toggle.stocks>
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text"><b class="space">categoria de valores</b></span>
                            <span class="info-box-number">
                                <h4>
                    ...
                    <b-collapse id="stocks" title="Stocks" header-bg-variant="light">
                        <b-card>
                            <table class="table">
                                <thead>
                                    <th>
                                        <small><b>Categoria de articulo</b></small>
                                    </th>
                                    <th>
                            ...
                            <template #modal-footer>
                                <div class="w-100">
                                    <small class="float-left text-muted"
                                        v-if="stocksPerCategory.length < categoryLength">Hay una categoria de articulo
                                        que no se usa </small>
                                    <small class="float-left text-muted"
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="info-box mb-3" v-b-toggle.crit>
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text"><b class="space">Articulos criticos</b></span>
                        ...
                        <b-card>
                            <table class="table">
                                <thead>
                                    ...
                                    <th>
                                        <small><b>Articulo</b></small>
                                    </th>
                                    <th class="centerx">
                                        <small><b>valoras izquierda</b></small>
                                    </th>
                                    <th class="centerx">
                                        <small><b>Nivle critico</b></small>
                                    </th>
                                </thead>
                                <tbody>
                            ...
                            <template #modal-footer>
                                <div class="w-100">
                                    <small class="float-left text-muted">Optenga suministros adicionales de estos
                                        articulos de esta lista.</small>
                                </div>
                            </template>
                        </b-card>
                    </b-collapse>
            ...
            <div class="row filts">
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="info-box mb-3" v-b-modal.totalItemSold>
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text"><b class="space">articulos vendidos</b></span>
                    ...
                    <b-modal id="totalItemSold" title="Total Items Sold" header-bg-variant="light" size="xl" hide-footer
                        hide-header>
                        <div class="info-box">
                            <span class="info-box-icon bg-light elevation-1"><i class="fas fa-tags"></i></span>
                            <div class="info-box-content">
                                ...
                                <span class="info-box-text">
                                    <h3 class="space2">articulos vendidos</h3>
                                </span>

                            </div>
                        </div>
                        <b-card>
                            <GChart id="Gchart" type="BarChart" :data="itemsSoldChart" :options="chartOptions"
                                v-if="onlineBa" />
                            ...
                            <template #modal-footer>
                                <div class="w-100">
                                    <small class="float-left text-muted">Optenga suministros adicionales de los
                                        articulos de esta lista.</small>
                                </div>
                            </template>
                        </b-card>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="info-box" v-b-modal.productPurchase>
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text"><b class="space">Elementos comprados</b></span>
                            <span class="info-box-number">
                    ...
                    <b-modal id="productPurchase" size="xl" hide-footer hide-header>
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <br />
                                <span class="info-box-text">
                                    <h3 class="space2">Elementos comprados</h3>
                                </span>
                            </div>
                        </div>
                        <b-card>
                            <b-row>
                                <b-col>
                                    <b-form-datepicker id="from2" v-model="fromDateValue2" :max="toDateValue2"
                                        placeholder="From" menu-class="w-100" calendar-width="100%"
                                        size="lg"></b-form-datepicker>
                                </b-col>
                                <b-col>
                                    <b-form-datepicker id="to2" v-model="toDateValue2" :max="max" :min="fromDateValue2"
                                        placeholder="To" menu-class="w-100" calendar-width="100%"
                                        size="lg"></b-form-datepicker>
                                </b-col>
                                <b-col cols="1">
                            ...
                            <br />
                            <GChart id="Gchart" type="ColumnChart" :data="productSoldPerDate" :options="chartOptions"
                                v-if="onlineBa" />
                            ...
                            <template #modal-footer>
                                <div class="w-100">
                                    <small class="float-left text-muted">Cuantas veces se compra un producto segun el
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="info-box" v-b-modal.includedInPurchase>
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text"><b class="space">Resumen de lo comprado</b></span>
                            <span class="info-box-number">
                                <h4>
                    ...
                    <b-modal id="includedInPurchase" title="Purchase Summary" size="xl" hide-footer hide-header>
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <br />
                                <span class="info-box-text">
                                    <h3 class="space2">Resumen de lo comprado</h3>
                                </span>
                            </div>
                        </div>
                        <b-card>
                            <GChart id="Gchart" type="PieChart" :settings="{ packages: ['corechart'] }" :data="x"
                                :options="chartOptions" v-if="onlineBa" />

                            <table class="table" v-else>
                                <thead>
                                    <th>Indice</th>
                                    <th>Producto</th>
                                    <th>Tiempos incluidos en una compra</th>
                                </thead>
                                <tbody>
                            ...
                            <template #modal-footer>
                                <div class="w-100">
                                    <small class="float-left text-muted">Cuantas veces se incluye un producto en una
                                        compra.</small>
                                </div>
                            </template>
                        </b-card>
                        ...
                        <div class="card-header" style="background-color: #f2f3f4">
                            <b-row>
                                <b-col style="display: flex">
                                    ...
                                    <span class="btn btn-tool" v-b-toggle.collapse-1><i
                                            class="fas fa-chevron-down fa-2x"></i>
                                    </span>
                                </b-col>
                                <b-col cols="2">
                                    <b-form-input placeholder="Customer Id" v-model="customerId"
                        ...
                        <div class="card-body">
                            <b-collapse id="collapse-1" class="mt-2">
                                <b-row>
                                    <b-col></b-col>
                                    <b-col cols="1">
                                        <download-excel :data="filterData" class="exports"
                                    ...
                                    <b-col cols="1">
                                        <download-excel :data="filterData" type="csv" :name="dateToday + 'purchases'"
                                            class="exports">
                                ...
                                <div style="text-align: center">
                                    <h4 style="letter-spacing: 10px">Rango de fechas</h4>
                                </div>
                                <b-row id="dateFilterBox" align="center">
                                    <b-col cols="1"></b-col>
                                    <b-col>
                                        <!-- <label for="from">From</label> -->
                                        <b-form-datepicker id="from" v-model="fromDateValue" :max="toDateValue"
                                            placeholder="From" menu-class="w-100" calendar-width="100%"
                                            size="lg"></b-form-datepicker>
                                    </b-col>
                                    <b-col>
                                        <!-- <label for="to">To</label> -->
                                        <b-form-datepicker id="to" v-model="toDateValue" :max="max" :min="fromDateValue"
                                            placeholder="To" menu-class="w-100" calendar-width="100%"
                                            size="lg"></b-form-datepicker>
                                    </b-col>
                                    <b-col cols="1">
                                        <b-btn @click="clearDate()" variant="outline-secondary" style="width: 100%"
                                            size="lg">Clear</b-btn>
                                    </b-col>
                                    <b-col cols="1"></b-col>
                                </b-row>
                            ...
                            <table class="table">
                                <thead>
                                    <th class="text-muted">No de pedido</th>
                                    <th class="text-muted">Fecha de transaccion</th>
                                    <th class="text-muted" style="text-align:center">ID de cliente</th>
                                    <th class="text-muted">Importe en deuda</th>
            ...
            <tr v-if="opened.includes(pur.ID)" :key="index" style="background-color:#f2f3f4;">
              <td colspan="5">
                                ...
                                <tbody v-else>
                                    <template v-for="(pur, index) in filterData">
                                        <tr :key="pur.ID" :class="{ opened: opened.includes(pur.ID) }">
                                            ...
                                            <td style="text-align:center" @click="toggle(pur.ID)">
                                                {{ pur.customer_ID }}
                                            </td>
                                            <td @click="toggle(pur.ID)">
                ...
                <b-icon icon="receipt" @click="getDataToPrint(pur)"></b-icon>
                                        ...
                                        <tr v-if="opened.includes(pur.ID)" :key="index"
                                  ...
                                  ">
                                                        ...
                                                        <tbody v-for="(x, index) in naa2" :key="index" id="subTableVal">
                                                            <tr v-if="x.orderno != null && x.orderno == pur.ID"
                                                                class="noHoverEffect">

                                                                <td>
                                                                    <div v-for="a in getCustNames" :key="a.id">
                                                                        <p v-if="a.id === pur.customer_ID">{{ a.name }}
                                                                        </p>
                                                                    </div>

                                                                </td>

                                                                <td class="subTableVals" style="text-align:center">{{
        models(x.orderno).length
}}</td>

                                                                <td>
                                                            <tr v-for="(i, index) in prodWithSerails" :key="index"
                                                                class="noHoverEffect">

                                                                <table v-for="(x, k) in models(x.orderno)" :key="k"
                                                                    width="100%">
                                                                    <tbody>
        ...
        i.price.toLocaleString()
                                                                            ...
                                                                            <td class="text-right pull-right">
                                                                                <ul v-for="(
                                                  a, index
                                                ) in loadinvoiceimahe" :key="index">
                                                                                    <template
                                                                                        v-if="i.imageid == a.imgId">
                                                                                        <h5>
                                                                                            <b-badge
                                                                                                @click="reprint(a.invoiceimg)">Reprint
                                                                                                Invoice</b-badge>
                                                                                        </h5>
                                                                                    </template>
                                                                                </ul>
