                        ...
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#change-password"
                                        data-toggle="tab">Cambiar la contraseña</a></li>
                            </ul>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="activity">
                                    <h3 class="text-center">Mostrar la actividad del usuario</h3>
                                </div>
                                <!-- Setting Tab -->
                                    ...
                                    <form @click.prevent="updateInfo" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <div class="float-right d-sm-inline text-muted">Miembro desde:
                                ...
                                <div class="tab-pane" id="change-password">
                                    <form class="form-horizontal">
                                        <div class="form-group">
                                            <label for="current_password" class="col-sm-2 control-label">Contraseña
                                                actual</label>
                                        ...
                                        <div class="form-group">
                                            <label for="new_password" class="col-sm-2 control-label">Nueva
                                                contraseña</label>
                                        ...
                                        <div class="form-group">
                                            <label for="confirm_password" class="col-sm-2 control-label">Confirmar
                                                contarseña</label>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-12">
                                                <button @click.prevent="updatePassword" type="submit"
                                                    class="btn btn-success">Actualizar contraseña</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
